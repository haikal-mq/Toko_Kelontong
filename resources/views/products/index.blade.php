...
<body class="p-4">
    <h1 class="text-2xl font-bold mb-5">Tabel Produk Toko Dua Bersaudara</h1>
            ...
            <tr>
                ...
                <td class="border p-2 text-center">
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <button onclick="if(confirm('Yakin ingin menghapus item ini?')) { document.getElementById('form-delete{{ $p->id}}').submit(); }"class="text-red-500 font-medium">
    ...
    <div id="modal-edit-item" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
        <div class="bg-white p-6 rounded-2xl shadow-lg w-96">
            ...
            <form id="form-edit" action="{{ route('products.store') }}" method="post">
                @csrf
                @method('PUT')
                <label for="nama_barang" class="text-sm">Nama Barang</label>
    ...
    <script>
        ...
        function toggle_edit(item) {
            ...
            //mengatur route pada action form secra dinamis
